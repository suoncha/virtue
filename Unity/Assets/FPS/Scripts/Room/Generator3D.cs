...
{
    public static Generator3D Instance { get; private set; }
    ...
    public class CubeData
    {
        ...
        public CubeData(Vector3Int location, Vector3Int size)
        {
    ...
    [SerializeField] Vector3Int roomMinSize = new Vector3Int(5, 3, 5);
    ...
    public List<CubeData> allCubeDatas = new List<CubeData>();
    ...
    public Generator3D setSize(Vector3Int size)
    {
        this.size = size;
        return this;
    }

    public Generator3D setRoomCount(int roomCount)
    {
        this.roomCount = roomCount;
        return this;
    }

    public Generator3D setRoomMaxSize(Vector3Int roomMaxSize)
    {
        this.roomMaxSize = roomMaxSize;
        return this;
    }

    public Generator3D setSeed(int value)
    {
        this.Seed = value;
        return this;
    }
    ...
    {
        this.allCubeDatas.Add(new CubeData(location, size));
    }
